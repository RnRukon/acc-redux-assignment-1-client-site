...
function Footer() {
    return (
        ...
        <footer className=" bg-slate-300 dark:bg-slate-700">
            <div className="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
                <div>
                    <h2 className="mb-6 text-sm font-semibold text-slate-100 uppercase dark:text-slate-100">Company</h2>
                    <ul className="text-slate-100 dark:text-slate-100">
                        <li className="mb-4">
                ...
                <div>
                    <h2 className="mb-6 text-sm font-semibold text-slate-100 uppercase dark:text-slate-100">Help center</h2>
                ...
                <div>
                    <h2 className="mb-6 text-sm font-semibold text-slate-100 uppercase dark:text-slate-100">Legal</h2>
                    <ul className="text-slate-100 dark:text-slate-100">
                        <li className="mb-4">
                ...
                <div>
                    <h2 className="mb-6 text-sm font-semibold text-slate-100 uppercase dark:text-slate-100">Download</h2>
                    <ul className="text-slate-100 dark:text-slate-400">
                        <li className="mb-4">
            ...
            <div className="py-6 px-4 bg-slate-100 dark:bg-slate-500 md:flex md:items-center md:justify-between">
                <span className="text-sm text-slate-500 dark:text-slate-300 sm:text-center">© 2022 <a href="https://flowbite.com/">Rukon.js</a>. All Rights Reserved.
                </span>
                <div className="flex mt-4 space-x-6 sm:justify-center md:mt-0">
                    <a href="/#" className="text-slate-400 hover:text-slate-900 dark:hover:text-white">
